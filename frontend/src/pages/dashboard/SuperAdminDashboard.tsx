          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition text-left">
                <div className="font-medium text-gray-900">Gestionar Áreas</div>
                <div className="text-sm text-gray-500 mt-1">
                  Crear y administrar áreas del sistema
                </div>
              </button>
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition text-left">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  Tabla de antigüedad, límites y reglas
                </div>
              </button>
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition text-left">
                <div className="font-medium text-gray-900">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  Tipos de vacaciones y días económicos
                </div>
              </button>
            </div>
          </div>
