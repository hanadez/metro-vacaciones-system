...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const loadStats = async () => {
    try {
      // Aquí llamarías a tu API para obtener estadísticas reales
      setStats({
        total_areas: 5,
        total_empleados: 150,
  ...
  const quickActions = [
    {
      ...
      description: 'Crear y administrar áreas del sistema',
      icon: (
    ...
    },
    {
      ...
      description: 'Tabla de antigüedad, límites y reglas',
      icon: (
        <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
        </svg>
      ),
      action: () => navigate('/configuracion/global'),
    },
    {
      name: 'Gestionar Catálogos',
      description: 'Tipos de vacaciones y días económicos',
      icon: (
    ...
    },
    {
      ...
      description: 'Crear y gestionar administradores',
      icon: (
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Gestión global del sistema</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-3">
            {[
              { action: 'Nuevo área creada', detail: 'Operación Línea 2', time: 'Hace 2 horas' },
              { action: 'Usuario activado', detail: 'admin.l2@metro.gob.mx', time: 'Hace 3 horas' },
              { action: 'Configuración actualizada', detail: 'Tabla de antigüedad', time: 'Hace 1 día' },
            ].map((activity, index) => (
