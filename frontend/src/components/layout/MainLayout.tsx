...
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  // Menú para Admin de Área
  const adminAreaMenu: MenuItem[] = [
    {
      name: 'Dashboard',
      path: '/dashboard/area',
      icon: (
  ...
  const menu = user?.rol === 'superadmin' ? superAdminMenu : adminAreaMenu;
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 bg-blue-600">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-white font-bold text-lg">Metro</span>
          </div>
          <button
        ...
        <div className="px-6 py-4 border-b">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-gray-500">{user?.rol === 'superadmin' ? 'SuperAdmin' : 'Admin Área'}</p>
            </div>
          </div>
        </div>
